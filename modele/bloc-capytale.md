<!--
  Bloc « activités Capytale » à coller dans l'index.md d'une thématique
  (ou d'une rubrique tp/ projet/…).
  - Un lien par activité ; le texte du lien = le code.
  - URL = https://capytale2.ac-paris.fr/web/c/<code>
  Voir CONVENTIONS.md § Codes Capytale.
-->
